...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { date: @release.date, method: @release.method, quantity: @release.quantity, units: @release.units } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { date: @release.date, method: @release.method, quantity: @release.quantity, units: @release.units } }
